<?php defined('BASEPATH') OR exit('No direct script access allowed');
    ...
    */
        $autoload['model'] = array(
             'Pays_model' => 'm_pays',
             'Region_model' => 'm_region',
             'Province_model' => 'm_province',
             'Ville_model' => 'm_ville',
             'Quartier_model' => 'm_quartier',
             'Entreprise_model' => 'm_entreprise',
             'Banque_model' => 'm_banque',
             'Compte_model' => 'm_compte',
             'Status_model' => 'm_stauts',
             'Type_model' => 'm_type',
             'Portion_model' => 'm_portion',
             'Collaborateur_model' => 'm_collaborateur',
